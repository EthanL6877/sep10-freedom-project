...
Main source:   [Eductaional websites for Engineering](https://interestingengineering.com/culture/12-educational-websites-that-every-mechanical-engineer-should-know)
* Apps from source
...
* Least complex
  * [Instructables](https://www.instructables.com/)
    * Findings:After reading through these apps I found that each site has tools to help in building a model or DIY projects
    Are helpful when required to build a model or learn to expand prior knowledge
    * These apps follow through to teach in diverse ways some may include cooking, electronics, and wood work, but are not limited to.
 ...
 * Mildly complex
   * [EDX](https://www.edx.org/)
     * The site shows a multitude of programs and courses that support the role of Mechanical engineer including computer science, leadership/communication, and analytics
     * Many of the shown programs/courses is easily accessible for anyone while also having english, chinese, spanish, and even italian speakers
     * Can be accessed on I.O.S 15 or later and for Chrome ver.100 or after
...
* Sources
  *  [https://cyberknife.com/cyberknife-how-it-works/](https://cyberknife.com/cyberknife-how-it-works/)
  *  [https://radonc.ucsf.edu/cyberknife/](https://radonc.ucsf.edu/cyberknife/)
  *  [https://ahs.atlantichealth.org/conditions-treatments/cancer-care/cancer-treatment-options/cyberknife-radiosurgery.html](https://ahs.atlantichealth.org/conditions-treatments/cancer-care/cancer-treatment-options/cyberknife-radiosurgery.html)


* Most complex-Gadgets/software
  * Cyberknife
    * findings:They explain the uses of the Cyberknife that being it can target specific areas on the body with radiation even harder to reach places like the spine.
    * Has low risk of failure
    ...
    * With motion synchronization the Cyberknife can easily track and accommodate for the human body's movement to more easily track down a tumor or cancer.
